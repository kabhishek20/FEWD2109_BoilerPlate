window.addEventListener("load", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    // Iteration 5 : If the task is too long(greater than 20 characters) make the task smaller by considering only the first 20 characters and adding ... at the end
